...
function createList (getFood){
	...
	$('li').click(function() {
		...
		// var groceryItem = parseFloat($('#item').val();
		
		// $(groceryItem).append('#newGrocery');
		
		// console.log('grocery item');
	

	// function fillList(items){
	// 	var listItem = $('<li></li>').addClass('groceryItem');
	// 	listItem.text($('#newGrocery').val());
	// 	listItem.attr('item', 'ListItem');
	// 	listItem.appendTo('newGrocery');
